...
class HexStringTest {
    ...
    @Test
    void getSubstringStartingAt() {
        assertThat(new HexString("BABE99").getSubstringStartingAtByte(1)).isEqualTo(new HexString("BE99"));
    }

    @Test
    void getSubstringUpTo() {
        assertThat(new HexString("BABE99").getSubstringStartingAtByte(1)).isEqualTo(new HexString("BE99"));
    }

    @Test
    void getSha256Hash() {
        assertThat(new HexString("BABE99").getSha256Hash())
                .isEqualTo(new HexString("e9e3433658ec59abaa5619e1d99e66ee7c2e3dd5e274b2dac4cc112e77073628"));
    }

    @Test
    void append() {
        assertThat(new HexString("C0FFEE").append(new HexString("BABE"))).isEqualTo(new HexString("C0FFEEBABE"));
    }
