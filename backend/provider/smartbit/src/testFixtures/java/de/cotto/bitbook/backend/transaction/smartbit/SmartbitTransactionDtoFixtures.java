...
public class SmartbitTransactionDtoFixtures {
    public static final SmartbitTransactionDto SMARTBIT_TRANSACTION;

    static {
        SMARTBIT_TRANSACTION = new SmartbitTransactionDto(
                TRANSACTION_HASH,
                BLOCK_HEIGHT,
                DATE_TIME,
                FEES.getSatoshis(),
